...
- For zoning_lookup: extract the city name from parcel_lookup's `address` field (e.g., "1435 N DORSEY LN   TEMPE  85288" → city="TEMPE") and pass as the `city` argument. The tool covers Tempe, Phoenix, Mesa, Scottsdale, Gilbert. If the parcel is in another Maricopa city (Chandler, Goodyear, Avondale, Surprise, Peoria, etc.) the tool will return jurisdiction="Outside covered jurisdictions" — surface that to the user as a known coverage gap.
