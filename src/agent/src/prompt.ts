...
- For zoning_lookup: extract the city name from parcel_lookup's "address" field (e.g., "1435 N DORSEY LN   TEMPE  85288" → city="TEMPE") and pass as the city argument. Coverage:
  ...
  - Hint-only stubs (no public zoning REST; tool confirms jurisdiction and points to the planning department): Chandler, Goodyear, Avondale, Surprise, Peoria. For these, surface the note verbatim — it tells the user where to look up zoning manually.
  - Outside coverage (Buckeye, Apache Junction, El Mirage, Tolleson, Fountain Hills, Litchfield Park, Paradise Valley, etc., or outside Maricopa County): tool returns jurisdiction="Outside covered jurisdictions" — surface that as a known gap.
